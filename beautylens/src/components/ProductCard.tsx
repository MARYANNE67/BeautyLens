 ...
 * with options to view the tutorial or dismiss.
...
export default function ProductCard({
  ...
  const NO_TUTORIAL_SUPPORT: string[] = ['brush', 'eyelash curler', 'beauty blender'];
  const productType = product.label?.toLowerCase() ?? '';
  const supportsTutorial = !NO_TUTORIAL_SUPPORT.includes(productType);
      ...
      <View style={styles.content}>
        ...
        {supportsTutorial ? (
          <View style={styles.buttonContainer}>
            ...
            >
              <Text style={styles.primaryButtonText}>View Tutorial</Text>
            </TouchableOpacity>
            <TouchableOpacity
          ...
          <View style={styles.infoContainer}>
            <Text style={styles.infoText}>
              Tutorial not available for this product type
            </Text>
          </View>
        )}
      </View>
